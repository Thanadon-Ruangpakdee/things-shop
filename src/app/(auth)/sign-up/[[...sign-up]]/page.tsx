...
export default function SignUpPage() {
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-white">
      ...
      {/* 🟢 ฝั่งซ้าย: Branding & Visual (เหมือนหน้า Sign-in) */}
      <div className="hidden lg:flex flex-col justify-between p-12 bg-zinc-950 text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-20 pointer-events-none">
          <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-emerald-600 rounded-full blur-[120px]"></div>
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-6xl font-black leading-tight mb-6 tracking-tighter">
            เริ่มต้นจัดการ <br />
            <span className="text-emerald-500">ธุรกิจของคุณ</span> <br />
            ในไม่กี่นาที
          </h1>
          <p className="text-zinc-400 text-lg max-w-md font-medium leading-relaxed">
            สมัครสมาชิกเพื่อเข้าถึงระบบจัดการสต็อกอัจฉริยะ และขยายฐานการขายผ่านระบบ Affiliate ระดับโปร
          </p>
        </div>
      ...
      <div className="flex items-center justify-center p-8 bg-slate-50/50">
        <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="lg:hidden flex flex-col items-center mb-8">
                ...
                <h2 className="text-2xl font-black text-slate-900 tracking-tight">สร้างบัญชี VapeHub</h2>
                <p className="text-slate-500 font-bold text-sm">เริ่มต้นการเดินทางของคุณได้ที่นี่</p>
            </div>
