# 🌬️ VapeHub - ระบบจัดการสต็อกสินค้าและตัวแทนแชร์ (Affiliate Management)

**VapeHub** คือระบบ Web Application สำหรับเจ้าของร้านค้าที่ต้องการจัดการสต็อกสินค้าอย่างเป็นระบบ พร้อมฟีเจอร์เด่นในการบริหารจัดการตัวแทนแชร์ (Affiliate) เพื่อเพิ่มยอดขายผ่านระบบนายหน้าอัจฉริยะ ออกแบบด้วยดีไซน์ที่ทันสมัยและใช้งานง่ายสไตล์ DashStack
